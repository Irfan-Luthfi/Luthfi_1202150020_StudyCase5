package com.example.masterluthfi.luthfi_1202150020_studycase5.UI;
...
import com.example.masterluthfi.luthfi_1202150020_studycase5.DatabaseHandler;
import com.example.masterluthfi.luthfi_1202150020_studycase5.R;
import com.example.masterluthfi.luthfi_1202150020_studycase5.RecyclerAdapter;
import com.example.masterluthfi.luthfi_1202150020_studycase5.SwipeHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    private LinkedList<com.example.masterluthfi.luthfi_1202150020_studycase5.Model.Activity> mActivity = new LinkedList<>();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == 1){
            ...
            databaseHandler.save(new com.example.masterluthfi.luthfi_1202150020_studycase5.Model.Activity(data.getStringExtra("activity"), data.getStringExtra("desc"), data.getStringExtra("priority")));
        }
        setRecyclerView();
